/**
 * POS design system — visual primitives for the terminal.
...
export { POSSearch } from "./POSSearch";
...
export type { POSIconButtonProps } from "./POSIconButton";
export type { POSInputProps } from "./POSInput";
